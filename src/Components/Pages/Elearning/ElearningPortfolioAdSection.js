...
import QCheck from "../../../assets/img/QuickChek.jpg";
import {
  AdTitleContainer,
  AdTitle,
  AdTitleBlack,
...
const ElearningPortfolioAdSection = () => {
      ...
      <AdGridContainer>
        <AdItemSection>
          ...
          >
            ...
            >
              Deltak - University of Texas Course
            </AdItemTitle>
          </AdItemLink>
        </AdItemSection>
        <AdItemSection>
          ...
          >
            <img
              src={Wiley}
              alt="Wiley The 5 Behaviors of a Cohesive Team"
              style={{
        ...
        <AdItemSection>
          ...
          >
            ...
            >
              QuickChek Onboarding Course Conversions
            </AdItemTitle>
          </AdItemLink>
        </AdItemSection>
      </AdGridContainer>
...
export default ElearningPortfolioAdSection;
