...
import BostonImage from "../../../assets/img/Brella_Web-refresh_Portfolio-Thumb_BostonScientificOrise.jpg";
import LabImage from "../../../assets/img/Brella_Web-refresh_Portfolio-Thumb_TransenterixSenhance_1000H.jpg";
import PatientImage from "../../../assets/img/PatientJourneyVideo.jpg";
import {
  AdTitleContainer,
  AdTitle,
  AdTitleBlack,
  ...
  return (
    <>
      ...
      <AdGridContainer>
        ...
        <AdItemSection>
          <AdItemLink
            to="/portfolio/jill-patient-interview"
            onClick={() => {
              sessionStorage.navScrollY = window.scrollY;
            }}
          >
...
export default VideoPortfolioAdSection;
